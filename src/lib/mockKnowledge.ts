// Comprehensive Company Employee Handbook (Demo Content)
...
export const mockPolicies: PolicyDocument[] = [
  ...
  content: 'Employees accrue sick leave at 1 hour per 30 hours worked, up to 80 hours (10 days) annually. Sick leave can be used for: Personal illness or injury; Medical appointments; Caring for immediate family members (spouse, children, parents); Mental health days (up to 3 per year). No advance notice required for sick leave, but notify your manager as soon as possible. For extended medical leave (3+ consecutive days), a doctor\'s note may be required. Unused sick leave carries over year to year up to 120 hours maximum. For serious health conditions, see our FMLA policy or contact HR at benefits@company.com.',
    category: 'Time Off',
  ...
  content: 'The Company supports growing families with comprehensive parental leave. Birth mothers receive 12 weeks fully paid leave plus 4 weeks at 60% pay. Non-birth parents (including adoptive parents) receive 6 weeks fully paid leave. Leave can be taken within 12 months of birth/adoption and doesn\'t need to be consecutive. During leave, we maintain health insurance benefits and guarantee job return. Employees can request flexible return-to-work arrangements including part-time schedules or remote work. We also provide lactation rooms in all offices and up to $500 reimbursement for breast pumps. Contact HR at least 30 days before expected leave date to begin planning.',
    category: 'Time Off',
