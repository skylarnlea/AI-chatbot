...
function generateContextualResponse(message: string): {
  response: string;
  ...
  if (
    ...
    response =
      "Hello! I'm your company AI assistant. I can help you with information about our policies, benefits, HR procedures, and workplace guidelines. What would you like to know about?";
  } else if (
    ...
    response =
      'I\'d be happy to help you with company policies and information! I have access to details about benefits, time off, remote work, expenses, and workplace guidelines. Could you be more specific about what you\'re looking for? For example, you could ask about:\n\n• "What are our vacation days?"\n• "How does remote work policy work?"\n• "What benefits do we have?"\n• "How do I submit expenses?"';
  }
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(
      `Message sent at: ${timestamp}, received at: ${new Date().toISOString()}`,
    );
    ...
    const { response: aiResponse, sources } =
...
export async function GET() {
  return NextResponse.json({ error: "Method not allowed" } as ErrorResponse, {
    status: 405,
  });
}
